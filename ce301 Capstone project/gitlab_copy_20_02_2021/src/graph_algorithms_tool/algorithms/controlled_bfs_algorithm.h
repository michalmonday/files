#ifndef CONTROLLEDBFSALGORITHM_H
#define CONTROLLEDBFSALGORITHM_H
...
extern const int BFS_STATE_INIT;
extern const int BFS_STATE_NEW_NODE_SELECTED;
extern const int BFS_STATE_ADJACENT_NODES_UPDATED;

class ControlledBfsAlgorithm : public ControlledAlgorithm
{
public:
    ControlledBfsAlgorithm(Graph *graph);

    // ControlledAlgorithm interface
    virtual void reset() override;
    virtual void step() override;
    virtual QString name() override { return "Breadth first search"; }
    ...
    QQueue<Node *> queue() { return queue_; }
...
#endif // CONTROLLEDBFSALGORITHM_H
